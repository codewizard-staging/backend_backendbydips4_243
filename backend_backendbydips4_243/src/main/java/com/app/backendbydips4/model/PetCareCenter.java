package com.app.backendbydips4.model;
...
import com.app.backendbydips4.converter.DurationConverter;
import com.app.backendbydips4.converter.UUIDToByteConverter;
import com.app.backendbydips4.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"backendbydips4\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"backendbydips4\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"backendbydips4\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"backendbydips4\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"backendbydips4\"")
